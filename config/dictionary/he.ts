...
export const he: Dictionary = {
  ...
  auth: {
    aside: {
      eyebrow: 'אזור בעלי השמחה',
      title: 'כל אישורי ההגעה במקום אחד',
      points: [
        'הזמנה דיגיטלית שנשלחת בוואטסאפ ונפתחת בלי אפליקציה',
        'דשבורד שמתעדכן ברגע שאורח עונה',
        'בדיקה חינמית, תשלום חד-פעמי רק כשמפעילים',
      ],
    },
    fields: {
      email: 'כתובת אימייל',
  ...
  footer: {
    ...
    tagline: 'הזמנה דיגיטלית, שיתוף בוואטסאפ ודשבורד אישורי הגעה — בלי מנוי ובלי תשלום לפי אורח.',
    productHeading: 'המוצר',
    legalHeading: 'מידע ומדיניות',
    login: 'כניסה לחשבון',
    signup: 'יצירת אירוע לבדיקה',
  },
  landing: {
    meta: {
    ...
    closing: {
      ...
      title: 'ההזמנה הבאה שלכם מוכנה בכמה דקות',
      body: 'יוצרים אירוע, מעצבים את ההזמנה ובודקים עם עד 10 אישורי הגעה — בחינם, בלי כרטיס אשראי. משלמים רק כשמפעילים.',
      cta: 'יצירת אירוע לבדיקה',
      secondary: 'דברו איתנו בוואטסאפ',
    },
  },
};
