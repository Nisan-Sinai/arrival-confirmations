...
export const PLAN_CATALOG: readonly PlanDefinition[] = [
  ...
  },
  {
    ...
    priceAgorot: 19_900,
    attendeeLimit: 1_000,
    description: 'מערכת מלאה לאוטומציה, עיצוב וניהול המוזמנים באירוע.',
    highlighted: true,
    features: [
      'כל מה שב-Basic',
      'עד 1,000 מוזמנים',
      'יבוא ועדכון מוזמנים מ-Excel, CSV ו-TSV',
      'WhatsApp אוטומטי ותזכורות מתוזמנות',
      'שליחה רק למי שעדיין לא השיב',
      'מיתוג מתקדם עם לוגו, צבעים וסגנונות',
      'מפת שולחנות ומושבים',
      'מעקב אחרי הודעות שנשלחו, ממתינות או נכשלו',
    ],
  },
] as const;
