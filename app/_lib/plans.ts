...
export const PLAN_CATALOG: readonly PlanDefinition[] = [
  ...
  },
  {
    ...
    priceAgorot: 19_900,
    attendeeLimit: 1_000,
    description: 'מסלול מתקדם בהשקה מוקדמת. האוטומציות ייפתחו לאחר השלמת החיבורים.',
    highlighted: true,
    features: [
      'כל מה שב-Basic',
      'עד 1,000 מוזמנים',
      'יבוא מוזמנים מ-Excel — בקרוב',
      'WhatsApp אוטומטי ותזכורות — בקרוב',
      'מיתוג מתקדם והושבה — בקרוב',
    ],
  },
] as const;
