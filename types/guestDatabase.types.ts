...
export type GuestDatabase = Omit<Database, 'public'> & {
  public: Omit<PublicSchema, 'Tables'> & {
    Tables: Omit<PublicSchema['Tables'], 'guests'> & {
      guests: {
        Row: GuestRow;
        Insert: GuestInsert;
        Update: GuestUpdate;
        Relationships: PublicSchema['Tables']['guests']['Relationships'];
      };
    };
  };
};

export type GuestSupabaseClient = SupabaseClient<GuestDatabase>;
