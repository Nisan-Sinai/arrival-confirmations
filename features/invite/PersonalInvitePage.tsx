...
export async function PersonalInvitePage({ locale }: { readonly locale: Locale }) {
    ...
    return (
      <main id="main" className="flex flex-1 items-center justify-center px-4 py-16">
        <Card padding="lg" className="max-w-lg text-center">
          <h1 className="text-h1 text-primary font-bold">{copy.personalInvalidTitle}</h1>
          <p className="text-muted-foreground mt-4 leading-relaxed">{copy.personalInvalidBody}</p>
  ...
  if (event === null) {
    return (
      <main id="main" className="flex flex-1 items-center justify-center px-4 py-16">
        <Card padding="lg" className="max-w-lg text-center">
          <h1 className="text-h1 text-primary font-bold">{copy.eventUnavailableTitle}</h1>
          <p className="text-muted-foreground mt-4 leading-relaxed">{copy.eventUnavailableBody}</p>
          <div className="mt-6 flex justify-center">
            <LanguageSwitch locale={locale} />
          </div>
        </Card>
  ...
  const db = privileged as unknown as SupabaseClient;
  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-label={copy.personalBrandedInvitation}
      >
